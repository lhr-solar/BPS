...
#pragma message ("PER_MINION_BOARD_VOLT_SENSORS set to      " XSTR(PER_MINION_BOARD_VOLT_SENSORS))

#pragma message ("NUM_TEMPERATURE_SENSORS set to            " XSTR(NUM_TEMPERATURE_SENSORS))

#pragma message ("PER_MINION_BOARD_TEMP_SENSORS set to      " XSTR(PER_MINION_BOARD_TEMP_SENSORS))
...
#pragma message ("BPS_ENABLE_PRINT_OUTPUT set to            " XSTR(BPS_ENABLE_PRINT_OUTPUT))
