// WDTimer.cpp
/**
 * Driver for the watch dog timer. Whenever the Windown Watch Dog Timer reaches 0,
 * all contactors will be opened (the battery pack will be disconnected from the car), and a system reset will be generated.
