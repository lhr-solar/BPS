...
int main(int argc, char **argv) {
    ...
    OSTaskCreate(&Task1_TCB,"Task 1",Task1,(void *) 0,1,Task1_Stk,16,256,0,0,(void *) 0,OS_OPT_TASK_SAVE_FP | OS_OPT_TASK_STK_CHK,
                &err);
                assertOSError(err);
    OSTaskCreate(&Task2_TCB,"Task 2",Task2,(void *) 0,1,Task2_Stk,16,256,0,0,(void *) 0,OS_OPT_TASK_SAVE_FP | OS_OPT_TASK_STK_CHK,
                &err);
                assertOSError(err);
    //while (err != OS_ERR_NONE);
    //__enable_irq();
